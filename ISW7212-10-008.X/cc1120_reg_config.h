...
const registerSetting_t preferredSettings[]= 
{
  ...
  {CC1120_FS_CFG,            0x12},
  {CC1120_WOR_CFG1,          0xC8},
  {CC1120_WOR_CFG0,          0x20},//21},     // for transmitter
  {CC1120_WOR_EVENT0_MSB,    0xFF},//17},     // for now, WOR wakes up every ~4s
